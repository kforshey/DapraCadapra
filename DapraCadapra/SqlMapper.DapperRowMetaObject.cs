...
namespace DapraCadapra
{
    ...
    {
        sealed class DapraCadapraRowMetaObject : System.Dynamic.DynamicMetaObject
        {
            static readonly MethodInfo getValueMethod = typeof(IDictionary<string, object>).GetProperty("Item").GetGetMethod();
            static readonly MethodInfo setValueMethod = typeof(DapraCadapraRow).GetMethod("SetValue", new Type[] { typeof(string), typeof(object) });

            public DapraCadapraRowMetaObject(
