...
namespace DapraCadapra
{
    partial class SqlMapper
    {
        partial class GridReader
        {
            ...
            {
                return ReadAsyncImpl<dynamic>(typeof(DapraCadapraRow), buffered);
            }
            ...
            {
                return ReadRowAsyncImpl<dynamic>(typeof(DapraCadapraRow), Row.First);
            }
            /// <summary>
            /// Read an individual row of the next grid of results, returned as a dynamic object
            /// </summary>
            ...
            {
                return ReadRowAsyncImpl<dynamic>(typeof(DapraCadapraRow), Row.FirstOrDefault);
            }
            /// <summary>
            /// Read an individual row of the next grid of results, returned as a dynamic object
            /// </summary>
            ...
            {
                return ReadRowAsyncImpl<dynamic>(typeof(DapraCadapraRow), Row.Single);
            }
            /// <summary>
            /// Read an individual row of the next grid of results, returned as a dynamic object
            /// </summary>
            ...
            {
                return ReadRowAsyncImpl<dynamic>(typeof(DapraCadapraRow), Row.SingleOrDefault);
            }
