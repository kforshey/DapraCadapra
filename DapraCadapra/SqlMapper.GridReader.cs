...
namespace DapraCadapra
{
    ...
    {
        /// <summary>
        /// The grid reader provides interfaces for reading multiple result sets from a DapraCadapra query
        /// </summary>
        public partial class GridReader : IDisposable
        {
            ...
            {
                return ReadImpl<dynamic>(typeof(DapraCadapraRow), buffered);
            }
            ...
            {
                return ReadRow<dynamic>(typeof(DapraCadapraRow), Row.First);
            }
            /// <summary>
            /// Read an individual row of the next grid of results, returned as a dynamic object
            /// </summary>
            ...
            {
                return ReadRow<dynamic>(typeof(DapraCadapraRow), Row.FirstOrDefault);
            }
            /// <summary>
            /// Read an individual row of the next grid of results, returned as a dynamic object
            /// </summary>
            ...
            {
                return ReadRow<dynamic>(typeof(DapraCadapraRow), Row.Single);
            }
            /// <summary>
            /// Read an individual row of the next grid of results, returned as a dynamic object
            /// </summary>
            ...
            {
                return ReadRow<dynamic>(typeof(DapraCadapraRow), Row.SingleOrDefault);
            }
