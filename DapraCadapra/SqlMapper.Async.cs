...
namespace DapraCadapra
{
    public static partial class SqlMapper
    {
        ...
        {
            return QueryAsync<dynamic>(cnn, typeof(DapraCadapraRow), new CommandDefinition(sql, param, transaction, commandTimeout, commandType, CommandFlags.Buffered, default(CancellationToken)));
        }
        ...
        {
            return QueryAsync<dynamic>(cnn, typeof(DapraCadapraRow), command);
        }
        ...
        {
            return QueryRowAsync<dynamic>(cnn, Row.First, typeof(DapraCadapraRow), command);
        }
        /// <summary>
        /// Execute a single-row query asynchronously using .NET 4.5 Task.
        /// </summary>
        ...
        {
            return QueryRowAsync<dynamic>(cnn, Row.FirstOrDefault, typeof(DapraCadapraRow), command);
        }
        /// <summary>
        /// Execute a single-row query asynchronously using .NET 4.5 Task.
        /// </summary>
        ...
        {
            return QueryRowAsync<dynamic>(cnn, Row.Single, typeof(DapraCadapraRow), command);
        }
        /// <summary>
        /// Execute a single-row query asynchronously using .NET 4.5 Task.
        /// </summary>
        ...
        {
            return QueryRowAsync<dynamic>(cnn, Row.SingleOrDefault, typeof(DapraCadapraRow), command);
        }
