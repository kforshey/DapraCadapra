/*
 ...
 Home page: https://github.com/StackExchange/DapraCadapra-dot-net
 */
...
namespace DapraCadapra
{
    ...
    /// <summary>
    /// DapraCadapra, a light weight object mapper for ADO.NET
    /// </summary>
    public static partial class SqlMapper
    {
        ...
        /// <summary>
        /// Return a count of all the cached queries by DapraCadapra
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Return a list of all the queries cached by DapraCadapra
        /// </summary>
        ...
        private static void ResetTypeHandlers(bool clone)
        {
            ...
            try // see https://github.com/StackExchange/DapraCadapra-dot-net/issues/424
            {
...
#pragma warning restore 618
        ...
        /// <remarks>
        /// This is typically used when the results of a query are not processed by DapraCadapra, for example, used to fill a <see cref="DataTable"/>
        ...
        {
            return Query<DapraCadapraRow>(cnn, sql, param as object, transaction, buffered, commandTimeout, commandType);
        }
        ...
        {
            return QueryFirst<DapraCadapraRow>(cnn, sql, param as object, transaction, commandTimeout, commandType);
        }
        /// <summary>
        /// Return a dynamic object with properties matching the columns
        /// </summary>
        ...
        {
            return QueryFirstOrDefault<DapraCadapraRow>(cnn, sql, param as object, transaction, commandTimeout, commandType);
        }
        /// <summary>
        /// Return a dynamic object with properties matching the columns
        /// </summary>
        ...
        {
            return QuerySingle<DapraCadapraRow>(cnn, sql, param as object, transaction, commandTimeout, commandType);
        }
        /// <summary>
        /// Return a dynamic object with properties matching the columns
        /// </summary>
        ...
        {
            return QuerySingleOrDefault<DapraCadapraRow>(cnn, sql, param as object, transaction, commandTimeout, commandType);
        }
       ...
       /// <param name="clause"></param>
        ...
        private static IEnumerable<T> QueryImpl<T>(this IDbConnection cnn, CommandDefinition command, Type effectiveType)
        {
            ...
            try
            {
                ...
                {
                    if (reader.FieldCount == 0) //https://code.google.com/p/DapraCadapra-dot-net/issues/detail?id=57
                        yield break;
        ...
        private static Func<IDataReader, object> GetDeserializer(Type type, IDataReader reader, int startBound, int length, bool returnNullIfFirstMissing)
        {
            ...
            if (type == typeof(object)
                || type == typeof(DapraCadapraRow))
            {
                return GetDapraCadapraRowDeserializer(reader, startBound, length, returnNullIfFirstMissing);
            }
        ...
        internal static Func<IDataReader, object> GetDapraCadapraRowDeserializer(IDataRecord reader, int startBound, int length, bool returnNullIfFirstMissing)
        {
            ...
            return
                r =>
                {
                    if (table == null)
                    {
                        ...
                        table = new DapraCadapraTable(names);
                    }
                    ...
                    return new DapraCadapraRow(table, values);
                };
        }
        /// <summary>
        /// Internal use only
...
#pragma warning restore 618
        ...
        /// </summary>
        private const string DataTableTypeNameKey = "DapraCadapra:TypeName";
