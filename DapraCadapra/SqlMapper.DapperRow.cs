...
namespace DapraCadapra
{
    ...
    {
        private sealed class DapraCadapraRow
            : System.Dynamic.IDynamicMetaObjectProvider
            , IDictionary<string, object>
        {
            readonly DapraCadapraTable table;
            object[] values;

            public DapraCadapraRow(DapraCadapraTable table, object[] values)
            {
            ...
            {
                var sb = GetStringBuilder().Append("{DapraCadapraRow");
            ...
            {
                return new DapraCadapraRowMetaObject(parameter, System.Dynamic.BindingRestrictions.Empty, this);
            }
